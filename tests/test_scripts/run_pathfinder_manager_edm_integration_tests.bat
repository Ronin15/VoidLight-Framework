@echo off
rem PathfinderManager EDM Integration Test Runner
...
if /i "%~1"=="--help" (
    echo !BLUE!PathfinderManager EDM Integration Test Runner!NC!
    echo Usage: run_pathfinder_manager_edm_integration_tests.bat [options]
    echo.
    echo Options:
...
echo !BLUE!Running PathfinderManager EDM Integration Tests!NC!
...
if !TEST_RESULT! neq 0 (
    ...
    echo !GREEN!pathfinder_manager_edm_integration_tests completed successfully!NC!
)

rem Show summary
if !OVERALL_RESULT! neq 0 (
    echo.
    echo !RED!PathfinderManager EDM Integration tests failed!!NC!
    exit /b 1
) else (
    echo.
    echo !GREEN!All PathfinderManager EDM Integration tests completed successfully!!NC!
    exit /b 0
)
